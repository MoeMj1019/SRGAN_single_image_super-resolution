...
parser.add_argument("--LR_path", type = str, default = 'train_data/realistic_nature_100/train_LR/')
parser.add_argument("--GT_path", type = str, default = 'train_data/realistic_nature_100/train_HR/')
